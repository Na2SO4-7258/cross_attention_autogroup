...
def main():
    ...
    model=LatentRetouchModel(cfg.attention_dim,cfg.edit_dim,cfg.cross_attention_heads,cfg.attention_spatial_size,cfg.encoder_base_dim,cfg.encoder_mid_dim,cfg.enhancer_base_dim,cfg.enhancer_mid_dim,ablation_uniform_weight=cfg.ablation_uniform_weight,ablation_cnn_fusion=cfg.ablation_cnn_fusion);trainer=Trainer(model,cfg,train,val,test);start=1;best=-float("inf")
    if args.resume:
